...
一个面向 TauriTavern / SillyTavern 预设作者的 PromptManager 条目管理工具。它提供双栏预设工作台：左侧选择来源预设，右侧选择目标预设，可以搜索、过滤、复制、收藏、重排、启用/停用、比对差异和预览条目；所有修改都会先作为未保存修改保留，只有点击“保存预设”才会写回目标 OpenAI 预设。
...
```javascript
import 'https://cdn.jsdelivr.net/gh/jerryzmtz/tauritavern-preset-manager@v2.12/dist/preset-manager/index.js';
```
...
2. 左侧选择来源预设，右侧选择目标预设。复制、删除、排序和开关修改都会先停留在面板草稿里，点击“保存预设”后才写回 OpenAI 预设。
